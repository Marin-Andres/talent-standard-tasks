...
export default class VerifyClient extends React.Component {
    ...
    checkToken(recruiterEmail, clientEmail, resetPasswordToken) {
        ...
        let url = `https://standardidentity-cmfdg8cgf6emcbcm.australiasoutheast-01.azurewebsites.net/authentication/authentication/verifyClientToken?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
        ...
        let resetUrl = `https://standardidentity-cmfdg8cgf6emcbcm.australiasoutheast-01.azurewebsites.net/authentication/authentication/validateInvitation?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
